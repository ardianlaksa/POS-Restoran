...
class TipeProdukSpinAdapter(context: Context, @LayoutRes resource: Int, list: ArrayList<TipeProdukListElement>)
    : ArrayAdapter<TipeProdukListElement>(context, resource, list){

    private var resource:Int
    private var mInflater:LayoutInflater? = null
    private var list:ArrayList<TipeProdukListElement>
