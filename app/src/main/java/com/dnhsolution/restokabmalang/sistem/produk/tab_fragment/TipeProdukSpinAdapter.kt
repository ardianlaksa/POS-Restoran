...
class TipeProdukSpinAdapter(context: Context, @LayoutRes resource: Int, list: ArrayList<KategoriElement>)
    : ArrayAdapter<KategoriElement>(context, resource, list){

    private var resource:Int
    private var mInflater:LayoutInflater? = null
    private var list:ArrayList<KategoriElement>
...
//             holder.tvItem = retView.findViewById(android.R.id.text1) as TextView
        ...
        holder.mId?.text = offerData.id
        holder.tvItem?.text = offerData.value1
