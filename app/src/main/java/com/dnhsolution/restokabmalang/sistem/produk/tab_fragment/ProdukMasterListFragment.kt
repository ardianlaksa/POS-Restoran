...
//        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        getAllKategoriProduk = getAppDatabase?.tblProdukKategoriDao()?.getAll()
    }
...
//                println("b :$jenisProduk")
                if(slctdTipeProduk == null)
                    kategoriList.forEachIndexed { index, element ->
                        if(element.id == jenisProduk) parent?.setSelection(index)
                    }
                slctdTipeProduk = kategoriList[position].id
    ...
    private fun dialogTambah() {
        ...
        val ivTambahFoto: ImageView = dialogView.findViewById<View>(R.id.ivTambahFoto) as ImageView
        val spiIsPajak = dialogView.findViewById<View>(R.id.spiIsPajak) as Spinner
        val spiTipeProduk = dialogView.findViewById<View>(R.id.spiTipeProduk) as Spinner
        val kategoriListViewModel = ViewModelProvider(this, ViewModelProvider.NewInstanceFactory())[KategoriListViewModel::class.java]
