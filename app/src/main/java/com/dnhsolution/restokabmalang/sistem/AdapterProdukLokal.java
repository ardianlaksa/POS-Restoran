...
public class AdapterProdukLokal extends RecyclerView.Adapter<AdapterProdukLokal.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView ivFoto,ivIcSync;
    ...
    public AdapterProdukLokal(List<ItemProduk> itemProduks, Context context){
